...
root.title("Parchis")
root.iconbitmap("tab.ico")

casilla_blanca = PhotoImage(file="Casilla_blanca.gif")      # Loading all the image files that are required in the game.
base_roja = PhotoImage(file="Base_roja.gif")     # Loading all the image files that are required in the game.
pieza_roja = PhotoImage(file="Pieza_roja.gif")          # Loading all the image files that are required in the game.
base_azul = PhotoImage(file="Base_azul.gif")
base_verde = PhotoImage(file="Base_verde.gif")
base_amarilla = PhotoImage(file="Base_amarilla.gif")
centro = PhotoImage(file="Centro.gif")
casilla_verde = PhotoImage(file="Casilla_verde.gif")
seguro_v = PhotoImage(file="Seguro_verde.gif")
casilla_a = PhotoImage(file="Casilla_amarilla.gif")
seguro_a = PhotoImage(file="Seguro_amarillo.gif")
casilla_azul = PhotoImage(file="Casilla_azul.gif")
seguro_azul = PhotoImage(file="Seguro_azul.gif")
casilla_r = PhotoImage(file="Casilla_roja.gif")
seguro_r = PhotoImage(file="Seguro_rojo.gif")
Flecha1 = PhotoImage(file="flecha1.gif")
Cola1 = PhotoImage(file="cola1.gif")
Flecha2 = PhotoImage(file="flecha2.gif")
Cola2 = PhotoImage(file="cola2.gif")
Flecha3 = PhotoImage(file="flecha3.gif")
Cola3 = PhotoImage(file="cola3.gif")
Flecha4 = PhotoImage(file="flecha4.gif")
Cola4 = PhotoImage(file="cola4.gif")
pieza_azul= PhotoImage(file="Pieza_azul.gif")
pieza_amirilla= PhotoImage(file="Pieza_amarilla.gif")
pieza_verde= PhotoImage(file="Pieza_verde.gif")

Label(image=base_roja, width=298, height=298).place(x=-1, y=-1)               #setting up board images
...
Label(image=centro, width=150, height=150).place(x=(298), y=(298))
...
def board():                            #Drawing the board, piece by piece.
    ...
    while (v != 250):     #Drawing Green boxes
        Label(image=casilla_verde, width=46, height=46).place(x=(350), y=(50 + v))
        v = v + 50

    Label(image=casilla_verde, width=46, height=46).place(x=(300), y=(100))
    Label(image=seguro_v, width=46, height=46).place(x=(400), y=(50))

    v = 0
    while (v != 250):     #Drawing Yellow boxes
        Label(image=casilla_a, width=46, height=46).place(x=(450 + v), y=(350))
        v = v + 50

    Label(image=casilla_a, width=46, height=46).place(x=(600), y=(300))
    Label(image=seguro_a, width=46, height=46).place(x=(650), y=(400))

    v = 0
    while (v != 250):    #Drawing Red Boxes
        Label(image=casilla_r, width=46, height=46).place(x=(50 + v), y=(350))
        v = v + 50

    Label(image=casilla_r, width=46, height=46).place(x=(100), y=(400))
    Label(image=seguro_r, width=46, height=46).place(x=(50), y=(300))

    v = 0
    while (v != 250):    #Drawing Blue Boxes
        Label(image=casilla_azul, width=46, height=46).place(x=(350), y=(450 + v))
        v = v + 50

    Label(image=seguro_azul, width=46, height=46).place(x=(300), y=(650))
    Label(image=casilla_azul, width=46, height=46).place(x=(400), y=(600))

    Label(image=Flecha1, width=46, height=46).place(x=250, y=400)        #Drawing arrows
    Label(image=Cola1, width=46, height=46).place(x=300, y=450)
    Label(image=Flecha2, width=46, height=46).place(x=400, y=450)
    Label(image=Cola2, width=46, height=46).place(x=450, y=400)
    Label(image=Flecha3, width=46, height=46).place(x=450, y=300)
    Label(image=Cola3, width=46, height=46).place(x=400, y=250)
    Label(image=Flecha4, width=46, height=46).place(x=300, y=250)
    Label(image=Cola4, width=46, height=46).place(x=250, y=300)
...
class YBox:                               #Class of yellow box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=pieza_amirilla, width=20, height=20)        #image of game piece.
...
class GBox:                             #Class of green box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=pieza_verde, width=20, height=20)
        self.double = double
...
class BBox:                           #Class of Blue box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=pieza_azul, width=20, height=20)
        self.double = double
...
class Box:                           #class of red box
    ...
    def __init__(self, num=-1, x=0, y=0, x0=0, y0=0, double=False, ):
        ...
        self.x0 = x0
        self.y0 = y0
        self.rap = Label(image=pieza_roja, width=20, height=20)
        self.double = double
